...
class untitled(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._tune_range = Range(88, 110, .2, 100, 200)
        ...
        self.iio_pluto_source_0.set_frequency((int(tune*1000000)))
        self.iio_pluto_source_0.set_samplerate(2400000)
        ...
        self.connect((self.analog_wfm_rcv_0, 0), (self.qtgui_freq_sink_x_3, 0))
    ...
    def set_tune(self, tune):
        self.tune = tune
        self.iio_pluto_source_0.set_frequency((int(self.tune*1000000)))
